...
(function () {
	...
	getLang().then((res) => {
		...
		let template = `<div class="content">
			...
			<ul id="stars">
				<li><img src="https://img.alicdn.com/tfs/TB1e8ulEAPoK1RjSZKbXXX1IXXa-44-44.png" alt=""></li>
				<li><img src="https://img.alicdn.com/tfs/TB1e8ulEAPoK1RjSZKbXXX1IXXa-44-44.png" alt=""></li>
				<li><img src="https://img.alicdn.com/tfs/TB1e8ulEAPoK1RjSZKbXXX1IXXa-44-44.png" alt=""></li>
				<li><img src="https://img.alicdn.com/tfs/TB1e8ulEAPoK1RjSZKbXXX1IXXa-44-44.png" alt=""></li>
				<li><img src="https://img.alicdn.com/tfs/TB1e8ulEAPoK1RjSZKbXXX1IXXa-44-44.png" alt=""></li>
			...
			<h3>${i18n.original[sourceLang]}</h3>
		...
		if(urlParam.target!==undefined){
			text.value = unescape(decodeURI(urlParam.target));
		}else{
			text.value = "你好";
		}
		if(urlParam.src!==undefined){
			originaltext.innerHTML = unescape(decodeURI(urlParam.src));
		}else{
			originaltext.innerHTML = "hello";
		}
		...
		li.forEach((item, i) => {
			item.addEventListener('click', () =>{
				...
				rate = i + 1
				li.forEach((liItem, j) => {
					liItem.innerHTML = j < rate ? '<img src="https://img.alicdn.com/tfs/TB1mWOgErvpK1RjSZFqXXcXUVXa-44-44.png" alt="">' : '<img src="https://img.alicdn.com/tfs/TB1e8ulEAPoK1RjSZKbXXX1IXXa-44-44.png" alt="">'
		...
		submit.addEventListener('click', () => {
			...
			if(rate> 0){
				...
				info.innerHTML=`${i18n.Ratinginfo[sourceLang]}`;
				info.setAttribute("id","prompt")
			}
		}, false)
